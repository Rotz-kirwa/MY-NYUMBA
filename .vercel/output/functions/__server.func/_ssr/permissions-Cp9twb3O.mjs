...
//#region node_modules/.nitro/vite/services/ssr/assets/permissions-Cp9twb3O.js
...
var db = queryClient ? drizzle(queryClient, { schema: schema_exports }) : new Proxy({}, { get(_target, prop) {
	if (prop === "then" || prop === "catch" || prop === "finally" || typeof prop === "symbol") return;
